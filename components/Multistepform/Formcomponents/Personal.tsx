...
function Personal() {
  return (
    ...
    <div className="h-[1185px]  md:h-[957px] mx-auto border-[1px] border-solid border-[#EDEDED] bg-[#FFFFFF] rounded-[10px] mb-[170px] person">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-[26px] mt-[26px] mr-[26px] ml-[35px]">
        <div className="form">
          <form>
        ...
        <div className="flex flex-col md:flex-row mt-[35px] mx-[35px] gap-[26px]">
          <div className="tour">
          <form>
